...
# Dataset path
path_dataset = '/ultralytics/datasets/signs_dataset/data.yaml'
...
while True :
    ...
    if path_dataset and os.path.exists(path_dataset):
        ...
        # Train the model
        results = model.train(data=path_dataset, epochs=100, imgsz=640, workers=0, batch=8, project="/ultralytics/yolo_share/training", name="first_train_signs_11")
